function [sigma0tvvedB,sigma0thhedB] = S2RT_Ulaby(mg,thetai)
%% 
f=5; % Frequency(GHz);
fg=f*1e9;
...
sigma0tvvwcm = sigma0gvv + sigma0cvv;
sigma0thhwcm = sigma0ghh + sigma0chh;
sigma0tvvedB = 10.*log10(sigma0tvv) - 10.*log10(sigma0tvvwcm);
sigma0thhedB = 10.*log10(sigma0thh) - 10.*log10(sigma0thhwcm);
end